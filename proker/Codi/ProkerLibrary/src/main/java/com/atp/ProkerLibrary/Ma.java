...
{        
    ...
    private final String[] DESCRIPCIO_COMBINACIO = {"Carta alta", "Parella", "Doble parella", "Trio", "Escala", "Color", "Full", "Poker", "Escala de color"};
...
//        System.out.println();
    ...
    public String descripcioMillorCombinacio() {
        int i=0;
        StringBuilder descripcioMillorCombinacio = new StringBuilder(DESCRIPCIO_COMBINACIO[millorsCombinacions.get(i).get(0)] + " amb ");
        for (int j=1; j<millorsCombinacions.get(i).size(); j++)
            descripcioMillorCombinacio.append(Carta.REPRESENTACIO_NUMS[millorsCombinacions.get(i).get(j)]);
        return descripcioMillorCombinacio.toString();
    }

    public String descripcioMillorCombinacioResumida() {
        return DESCRIPCIO_COMBINACIO[millorsCombinacions.get(0).get(0)];
    }
}
