...
public class Taula {
    ...
    public List<Combinacio> millorsCombinacionsTots;
    public List<String> descripcioMillorsCombinacionsTots;
    ...
    public void calculaMillorsCombinacions() {
        this.millorsCombinacionsTots = new ArrayList<>();
        this.descripcioMillorsCombinacionsTots = new ArrayList<>();
        for (Jugador j : jugadors) {
            this.millorsCombinacionsTots.add(j.millorsCombinacions(cartesTaula));
            this.descripcioMillorsCombinacionsTots.add(j.descripcioMillorCombinacio());
        }
    }

    public List<Jugador> calculaGuanyadors() {
        List<Jugador> jugadorsGuanyadors = new ArrayList<>();
        Combinacio millorCombinacio = this.millorsCombinacionsTots.get(0);
        jugadorsGuanyadors.add(this.jugadors.get(0));
        for (int i=1; i<this.millorsCombinacionsTots.size(); i++) {
            int resultatComparacio = this.millorsCombinacionsTots.get(i).compareTo(millorCombinacio);
            if (resultatComparacio==0)
                jugadorsGuanyadors.add(this.jugadors.get(i));
            else if (resultatComparacio>0) {
                millorCombinacio = this.millorsCombinacionsTots.get(i);
                jugadorsGuanyadors.clear();
                jugadorsGuanyadors.add(this.jugadors.get(i));
            }
        }
    ...
    public Combinacio getMillorCombinacio(int posicio) {
        return millorsCombinacionsTots.get(posicio);
    }

    public String getDescripcioMillorCombinacio(int posicio) {
        return descripcioMillorsCombinacionsTots.get(posicio);
    }
}
